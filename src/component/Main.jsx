            ...
            <div className='w-full h-full relative'>
                ...
                <div className='absolute w-full top-[20%] p-4 md:p-8'>
                    ...
                    <div className='mt-2 flex gap-2'>
                        <button className='border rounded-2xl bg-red-800 text-white border-red-800 py-2 px-2 flex gap-1 items-center'> < AiFillCaretRight  className="text-white mr-2 text-2xl"/>Play</button>
